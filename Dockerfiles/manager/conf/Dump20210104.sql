...
CREATE TABLE `AGENTS` (
  ...
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=16 DEFAULT CHARSET=utf8 COMMENT='Agent 테이블\n전체 agent 정보를 관리';
...
) ENGINE=InnoDB AUTO_INCREMENT=124 DEFAULT CHARSET=utf8 COMMENT='TASK 수행 정보 테이블';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `TASK_DETAIL` (
  ...
  `EVENT_HOOK_SENDING_TYPE` varchar(45) DEFAULT NULL COMMENT '이벤트 훅 전송 조건',
  PRIMARY KEY (`TASK_ID`),
...
-- Dump completed on 2021-01-04  9:55:32
