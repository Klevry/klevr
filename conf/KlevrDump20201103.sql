...
CREATE TABLE `AGENTS` (
  ...
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8 COMMENT='Agent 테이블\n전체 agent 정보를 관리';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='TASK 수행 정보 테이블';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2020-11-03 17:33:27
