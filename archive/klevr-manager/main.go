...
// DefaultConsulURL default consul url
const DefaultConsulURL string = "http://localhost:8500"

// ConsulURL Default API URL set
var ConsulURL = "http://localhost:8500"

// AgentDownload URL
var AgentDownload = "https://bit.ly/go_inst"
...
func run() int {
	...
	r.HandleFunc("/groups/{G}/users/{U}/zones/{Z}/platforms/{P}/aliveagent", func(w http.ResponseWriter, r *http.Request) {
		...
		communicator.Put_http(ConsulURL+ure, plan_data, API_key_string)
